...
//      //Website
      ...
      echo $linklogo;
      echo "<br>";
      //Tuyển dụng nhanh + "tiêu đề tin tuyển dụng" + lương cao + "năm hiện tại"
      $meta_title="Tuyển dụng nhanh ".$new_title." lương cao ".$namhientai;
        //"tên công ty" + tuyển dụng + "tên tiêu đề tin tuyển dụng" + lương cao + "năm hiện tại" trên timvieclam365.net
    $meta_desc=$tencongty." tuyển dụng ".$new_title." lương cao ".$namhientai." trên timvieclam365.net";
        //Việc làm + "tên tiêu đề tin tuyển dụng"
    $meta_keywork="việc làm ".$new_title;
   }
   else if($row['cra_luat'] == 7)
   {
      ...
      echo "<br>";
        //Công việc + "tiêu đề tin tuyển dụng" + uy tín chất lượng + "năm hiện tại"

      $meta_title="Công việc ".$new_title." uy tin chất lượng ".$namhientai;
        //Tìm việc + "tên tiêu đề tin tuyển dụng" + lương cao + tại + "tên công ty". Tìm hiểu thêm tại timvieclam365.net

        $meta_desc="Tìm việc ".$new_title." lương cao tại ". $tencongty.". Tìm hiểu thêm tại timvieclam365.net";
        //Tìm việc + "tên tiêu đề tin tuyển dụng" đi làm ngay
        $meta_keywork="Tìm việc ".$new_title." đi làm ngay";
   }
   if($row['cra_luat'] == 6)
   {
      //Chức vụ
      ...
      echo $linklogo;
      echo "<br>";
      //Việc làm + "tiêu đề tin tuyển dụng" + lương cao + "năm hiện tại"
      $meta_title="Việc làm ".$new_title." lương cao | ".$namhientai;
        //Tuyển dụng + "tên tiêu đề tin tuyển dụng" + lương cao + tại + "tên công ty" + "năm hiện tại"

        $meta_desc="Tuyển dụng ".$new_title." lương cao tại ".$tencongty." ".$namhientai ;
        //Tuyển dụng nhanh + "tên tiêu đề tin tuyển dụng" 
        $meta_keywork="tuyển dụng nhanh ".$new_title;
   }
   if($row["cra_luat"] == 5)
   {
      $chucvu = $link->find($luatchucvu,0);
   ...
   {      
      ...
      echo "<br>";
      $quymo_ct = 0;
      //Tuyển dụng việc làm + " tên tiêu đề tin tuyển dụng" + mới nhất + "năm hiện tại" 
      $meta_title="Tuyển dụng việc làm ".$new_title." mới nhất ".$namhientai;
        //"tên công ty" + tuyển dụng việc làm + "tên tiêu đề tin tuyển dụng" + "năm hiện tại" + mới nhất trên timvieclam365.net
        $meta_desc=$tencongty." tuyển dụng việc làm ".$new_title." ".$namhientai." mới nhất trên timvieclam365.net ";
        //Tìm việc làm +  "tên tiêu đề tin tuyển dụng"
        $meta_keywork="Tìm việc làm ".$new_title;
   }
...
$url = 'https://timvieclam365.net/cron/tu_get_data_rasu.php';
if($new_title != '')
{
      $curl = new cURL;

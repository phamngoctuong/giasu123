                        ...
                        <div class="detailjob-body1">
                            ...
                            <div class="col-md-4">
                                 <p><strong>Hình thức dạy: </strong> <?php $tg=explode(',',$item->LearnType);                                        
                                        ...
                                        ?></p>
                                <p><strong>Tìm giáo viên: </strong>  <?php $tg=explode(',',$item->TeacherSex);                                        
                                            echo GetSex($tg[0]).", ";
                                            if(isset($tg[1])){
                                                echo GetSex($tg[1]);
                                            }
                        ...
                        <div class="detaijob-body2 lichday">
                             <div class="col-md-15 col-sm-12 padd-l-5 padd-r-5">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <label class="<?php if($item->CMonNight ==0){ echo""; }else{ echo "active";}?>">Chiều</label>
                                    </li>
                                </ul>
                             </div> 
                             <div class="col-md-15 col-sm-12 padd-l-5 padd-r-5">
                             <div>Thứ 3
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <label class="<?php if($item->CTueNight ==0){ echo""; }else{ echo "active";}?>">Chiều</label>
                                    </li>
                                </ul>
                             </div>
                             <div class="col-md-15 col-sm-12 padd-l-5 padd-r-5">
                             <div>Thứ 4
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <label class="<?php if($item->CWeNight ==0){ echo""; }else{ echo "active";}?>">Chiều</label>
                                    </li>
                                </ul>
                             </div>
                             <div class="col-md-15 col-sm-12 padd-l-5 padd-r-5">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <label class="<?php if($item->CThuNight ==0){ echo""; }else{ echo "active";}?>">Chiều</label>
                                    </li>
                                </ul>
                             </div>
                             <div class="col-md-15 col-sm-12 padd-l-5 padd-r-5">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <label class="<?php if($item->CFriNight ==0){ echo""; }else{ echo "active";}?>">Chiều</label>
                                    </li>
                                </ul>
                             </div>
                             <div class="col-md-15 col-sm-12 padd-l-5 padd-r-5">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <label class="<?php if($item->CSatNight ==0){ echo""; }else{ echo "active";}?>">Chiều</label>
                                    </li>
                                </ul>
                             </div>
                             <div class="col-md-15 col-sm-12 padd-l-5 padd-r-5">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <label class="<?php if($item->CSunNight ==0){ echo""; }else{ echo "active";}?>">Chiều</label>
                                    </li>
                                </ul>
                             </div>                                         
                        </div>
                        ...
                        <div class="col-md-4 col-sm-12 padd-l-5 padd-r-5">
                            <div class="item_hd vip" data-object="<?php echo $n->UserID ?>" data-type="<?php echo $n->UserID ?>">
                               ...
                               <div class="right_item">
                                  <a href="<?php echo base_url().'lop-hoc/'.vn_str_filter($n->ClassTitle).'-'.$n->ClassID ?>" title="#" class="title_new"><?php echo $n->ClassTitle ?></a>
                                  <a href="" title="" class="title_co"><i class="fa fa-giasuname"></i><?php echo $n->Name ?></a>
          ...
          $.ajax(
              {
                  ...
                  success: function (reponse) {
                      if (reponse.kq == true) {                          
                          $('#txtviewphone').text('SĐT: '+reponse.obj.phone);

...
<section class="inner-header-title padd-top-20 padd-bot-20" style="background-image:url(images/banner-10.jpg);">
	<div class="container">
		<div class="row">
            <div class="col-md-12"><h1 class="padd-0 mrg-0 text-center font-30">Tìm kiếm việc làm fulltime</h1></div>
                <form class="frmparttime">
					<div class="col-md-4 col-sm-4">
									<input class="form-control" id="findparttime" aria-label="tìm việc" placeholder="Nhập tên công việc muốn tìm" type="text">
					</div>
        ...
        <div class="row">
            <div class="col-md-70 col-sm-12">
                <div class="vl_lc jobfulltime">
                    <div class="col-md-12 padd-0"><div class="tit_hd">
                        <div class="ir_h3">
                           <h3><span>Việc làm mới nhất</span></h3>
                        </div>
                        <a rel="nofollow" href="<?php echo base_url() ?>tim-viec-lam&keywork=all&n=0&t=0" class="span_hd">Xem tất cả <img src="images/ic_muiten.png" alt="Việc làm mới nhất"/></a>
                     </div>
                     </div>
                    <div class="">
                    <div class="giasutieubieu row">
                        <?php if(!empty($tinfulltime)){

                          foreach($tinfulltime as $n){
       ...
       $('.timvieclampartime').on('click',function(){
            ...
            if(key !='' ||  nganh !='' || tinh !=''){
                $.ajax({
                  ...
                  url: configulr+"site/ajaxsearchfulltime",
                  type: "POST",

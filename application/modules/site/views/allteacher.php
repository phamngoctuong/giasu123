    ...
    <div class="container">
        <div class="row giasutieubieu">
            <div class="col-md-12 titledetail">
                <div class="tit_hd">
                 <h3>Lớp mới đang tìm gia sư</h3>
              </div>
            </div>
            <div class="col-md-12 topmoney">
                <div class="row">
                  <div class="row-allteacher">
                    <?php
                    // if(!empty($lstitem)){
                            ...
                            <div class="col-md-3 col-sm-12 featureitem">
                                <div class="item_hd vip" data-object="<?php echo $n->UserID ?>" data-type="<?php echo $n->UserID ?>">
                                   ...
                                   <div class="right_item">
                                        ...
                                        <a rel="nofollow" href="" title=""  class="title_new" ><?php echo $n->Name ?></a>
                                        <?php if($n->Money > 0){ ?>
...
<section class="padd-top-10 padd-bot-30">
    <div class="container">
        <div class="row">
            <div class="col-md-70 col-sm-12">
                <div class="titlesearch">
                   <h3 class="vltg"><i class="fa fa-uv-newsest"></i> <span>Lớp có học phí cao nhất</span></h3>
                </div>
                <div class="main_itg">
                    <?php
                        // if(!empty($newitem)){
                              ...
                              ?>
                                <div class="itemnews">
                                    ...
                                    <div class="itemnews_r">
                                        <a rel="nofollow" target="_blank" href="<?php echo base_url().'lop-hoc/'.vn_str_filter($n->ClassTitle).'-'.$n->ClassID ?>" class="item-uv-name" tabindex="0"> <?php echo $n->ClassTitle ?> </a>
                ...
                <div class="box_job_search user">
        	        ...
        	        <div class="main_sc">
        	        	<form action="" method="post">
        					...
        					<div class="input">
        						<span class="icon-before" style="top:8px"><img src="images/iconhinhthuchoc.png" alt="Hình thức học"></span>
                    ...
                    <div class="list_workonline">
                        <?php if(!empty($lstonline)){
                            ...
                            <div class="item-uv-online">
                                <div class="item-uv-onlien-job"><a rel="nofollow" href="<?php echo base_url().'lop-hoc/'.vn_str_filter($n->ClassTitle).'-'.$n->ClassID ?>"><?php echo $n->ClassTitle ?></a></div>
                                ...
                                <div class="item-uv-online-chat">
                                    <span class="uvonline-chat">Chat với phụ huynh</span>

            ...
            <div class="content-right " style="min-height:300px;">
                ...
                <div class="ntdlist">
                    ...
                    <table id="tbllstclass">
                        ...
                        <tbody>
                            <?php if(!empty($candiamply)){ $i=0;
                            foreach($candiamply as $n){ $i+=1; ?>
                            <tr>
        ...
        <div class="modal-body">
            <div class="col-md-12">
                <div class="row padd-top-15 padd-bot-5" style="">   
                    <div class="col-md-12">
                        <select id="txtactive" name="txtactive">
                            <option value="">Chọn trạng thái</option>
                            <option value="1">Đồng ý</option>
                            <option value="2">Xếp lịch</option>
...
$(document).ready(function(){
    ...
    $('#loctimkiem').on('click',function(){
        $.ajax({
                          ...
                          url: configulr+"site/ajaxfiltercompanycandiamply",
                          type: "POST",
                          data: { 
                            monhoc: $('#monhoc').val(),
                            findkey:$('#findkey').val(),
    ...
    $('#tbllstclass').on('click','a.btnntdedit',function(){
            $('#txtghichu').val('');
            $('#txtactive').val($(this).attr('data-id'))
                ...
                $.ajax(
                      {
                          ...
                          url: configulr+"site/ajaxcompanyupdateusersjobs",
                          type: "POST",
                          data: { 
                            classid: $('#txtclassid').val() ,
                            note:$('#txtghichu').val(),
                            trangthai:$('#txtactive').val()
                          },
                          dataType: 'json',
                          beforeSend: function () {
                              $("#boxLoading").show();

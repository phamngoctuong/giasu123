            ...
            <div class="col-md-12"><h1 class="padd-0 mrg-0 text-center font-30">Tìm kiếm ứng viên</h1></div>
                <form class="frmparttime">
					<div class="col-md-4 col-sm-4">
									<input class="form-control" value="<?php if(!empty($fillkey['key'])&&$fillkey['key']!='all' ){ echo $fillkey['key'];} ?>" id="findparttime" aria-label="tìm việc" placeholder="Nhập tên công việc muốn tìm" type="text">
					</div>
        ...
        <div class="row">
            <div class="col-md-70 col-sm-12">
                <div class="vl_lc jobfulltime">
                    <div class="col-md-12 padd-0 mrg-bot-20"><div class="tit_hd">
                        <div class="ir_h3">
                           <h3><span>Danh sách ứng viên</span></h3>
                        </div>
                     </div>
                     </div>
                                    ...
                                    <div class="main_itg">
                                        <div class="itemnews">
                                            <div class="itemnews_l">
                                                <a rel="nofollow" href="<?php echo base_url()."ung-vien/".vn_str_filter($n->Name)."-uv".$n->UserID.".html"; ?>" class="logouser">
                                                <?php if(!empty($n->Image)){?>
                                            <img alt="<?php echo $n->Name ?>" src="<?= gethumbnail(geturlimageAvatar(strtotime($n->CreateDate)).$n->Image,$n->Image,strtotime($n->CreateDate),63,63,80) ?>" onerror='this.onerror=null;this.src="images/no-image2.png";' />
                                        <?php }else{ ?>
                                         <img src="<?= gethumbnail("images/no-image2.png","no-image2.png",strtotime($n->usc_create_time),63,40,80) ?>" alt="no image" onerror='this.onerror=null;this.src="images/no-image2.png";' />
                                         <?php } ?>
                                                </a>
                                                <span><?php if(!empty($n->Birth)){echo date("d/m/Y",strtotime($n->Birth));} ?></span>
                                            </div>
                                            <div class="itemnews_r">
                                                <a rel="nofollow" href="<?php echo base_url()."ung-vien/".vn_str_filter($n->Name)."-uv".$n->UserID.".html"; ?>" class="item-uv-name" title="<?php echo $n->Name ?>"><?php echo $n->Name ?></a>
            ...
            <div class="col-md-30 col-sm-12 col-right-search padd-l-0 allteacher">
                <div class="box_job_search topcompany">
                            ...
                            <div class="listcom">
                                 <div><a rel="nofollow" title="flc"><img src="images/logocty/flc.jpg" alt="flc" title="flc" /></a></div>
                                 <div><a rel="nofollow" title="gia sư toán"><img src="images/logocty/fpt.jpg" alt="fpt" title="fpt" /></a></div>
                                 <div><a rel="nofollow" title="gia sư lớp 12"><img src="images/logocty/samsung.jpg" alt="sam sung" title="sam sung" /></a></div>
                                 <div><a rel="nofollow" title="gia sư toán"><img src="images/logocty/sunhouse.jpg" alt="sunhouse" title="sunhouse" /></a></div>
                                 <div><a rel="nofollow" title="gia sư lớp 12"><img src="images/logocty/vietcombank.jpg" alt="vietcombank" title="vietcombank" /></a></div>
                                 <div><a rel="nofollow" title="gia sư toán"><img src="images/logocty/vingroup.jpg" alt="vingroup" title="vingroup" /></a></div>
                            </div>
                </div>
                <div class="box_job_search cate">
                    ...
                    <ul class="right_tg">
                        <?php if(!empty($topcat)){
                            foreach($topcat as $n){?>
                               <li><a rel="nofollow" href=""><?php echo $n->cat_name ?> <span>(<?php echo $n->tongbanghi ?>)</span></a></li>
                            <?php }
                        } ?>
                    </ul>
                 </div>
                            ...
                            ?><div class="col-md-3 col-sm-12 featureitem">
                                    <div class="item_hd vip" data-object="<?php echo $n->new_id ?>" data-type="<?php echo $n->new_id ?>">
                                       ...
                                       <div class="right_item">
                                            <a rel="nofollow" href="<?php echo base_url()."".vn_str_filter($n->new_title)."-job".$n->new_id.".html"; ?>" title="<?php echo $n->new_title ?>" class="title_co"><?php echo $n->new_title ?> </a>
                                          <a rel="nofollow"  class="title_new"><?php echo $n->usc_company ?></a>
                    ...
                    <?php if(!empty($topcandi)){ ////ung-vien/tran-trong-long-uv35.html
                        ...
                        ?><div class="col-md-3 col-sm-12 featureitem">
                                <div class="item_hd vip" data-object="<?php echo $n->UserID ?>" data-type="<?php echo $n->UserID ?>">
                                   ...
                                   <div class="right_item">
                                        <a rel="nofollow" href="<?php echo base_url()."ung-vien/".vn_str_filter($n->Name).'-uv'.$n->UserID.".html" ?>" title="<?php echo $n->Name ?>" class="title_co"><?php echo $n->Name ?> </a>
                                      <a rel="nofollow" href="<?php echo base_url()."ung-vien/".vn_str_filter($n->Name).'-uv'.$n->UserID.".html" ?>" title="<?php echo $n->Name ?>" class="title_new"><?php echo GetCategory(intval($n->cv_cate_id));  ?></a>
...
<script type="text/javascript">
	$(document).ready(function() {
       ...
       $('#txtnnpartime').select2();
       $('#txtcityparttim').select2();

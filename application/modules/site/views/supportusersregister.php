...
<section class="padd-top-0">
    ...
    <div class="col-left col-md-9 hdright">
      <div class="info">        
        <h3 class="title support"><i class="fa fa-info-circle"></i> Hướng dẫn đăng ký tài khoản</h3>
      </div>
      <div class="content">
        <p>Việc đăng kí tài khoản học viên, phụ huynh trên Giasu365 rất đơn giản, Quý khách chỉ mất khoảng 1 phút để thực hiện theo các bước sau đây :</p>
        <div class="step01"><h2><span><span>Bước 1:</span> Bấm vào nút <b>"Tạo tài khoản"</b> ở góc phải màn hình hoặc </span><a>bấm vào đây >></a></h2>            
        </div>
        <p><img src="images/buoc101.jpg" /></p>
        <div class="step01"><h2><span><span>Bước 2:</span> Chọn <b>"ĐĂNG KÝ TÌM GIA SƯ"</b></span></h2>    
              
        </div>
        <p><img src="images/buoc201.jpg" /></p>  
        ...
        <div class="step01">   
              <h4><span><span>Bước 3.2:</span> Mô tả yêu cầu tìm gia sư:</span></h4>
        </div>
        <ul>
                <li style="line-height: 30px;"><b>Tóm tắt yêu cầu tìm gia sư: </b><span>Ví dụ: Tìm gia sư tiếng Anh lớp 1 tại Hoàn Kiếm, Hà Nội</span></li>
                <li style="line-height: 30px;"><b>Yêu cầu gia sư là: </b><span>Lựa chọn gia sư là.</span></li>
                <li style="line-height: 30px;"><b>Giới tính: </b><span>Lựa chọn giới tính gia sư.</span></li>
                <li style="line-height: 30px;"><b>Môn học: </b><span>Lựa chọn môn học.</span></li>
                ...
                <li style="line-height: 30px;"><b>Số lượng học sinh: </b><span>Chọn số lượng học sinh bạn muốn gia sư dạy kèm.</span></li>                
                <li style="line-height: 30px;"><b>Số giờ học 1 buổi: </b><span>Chọn số giờ học/buổi.</span></li>
                <li style="line-height: 30px;"><b>Hình thức học: </b><span>Chọn hình thức học.</span></li>
                <li style="line-height: 30px;"><b>Học phí dự kiến: </b><span>Nhập mức học phí mà bạn mong muốn.</span></li>
                <li style="line-height: 30px;"><b>Địa chỉ email: </b><span>Nhập địa chỉ email của bạn.</span></li>
                <li style="line-height: 30px;"><b>Điện thoại liên hệ: </b><span>Nhập chính xác số điện thoại liên hệ của bạn.</span></li>
                <li style="line-height: 30px;"><b>Địa điểm diễn ra lớp học: </b><span>Chọn địa điểm diễn ra lớp học.</span></li>
                <li style="line-height: 30px;"><b>Địa chỉ cụ thể diễn ra lớp học: </b><span>Nhập tên đường, quận / huyện (rồi chọn từ danh sách hiển thị)</span></li>
                <li style="line-height: 30px;"><b>Buổi có thể học: </b><span>Bấm để chọn những buổi bạn có thể học.</span></li>
                <li style="line-height: 30px;"><b>Mô tả chi tiết nội dung muốn học: </b><span>Mô tả chi tiết nội dung bạn muốn học.</span></li>
            </ul>

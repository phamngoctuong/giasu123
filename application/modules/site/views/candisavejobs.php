                ...
                <div class="ntdlist">
                			  ...
                			  <div class="tab-pane active" id="1a">
                                    <div class="row mrg-0">
                                        ...
                                        <div class="col-md-3 col-2">
                                            <div class="form-control"><input type="text" id="findkey" name="findkey" placeholder="Nhập tiêu đề tin tuyển dụng"/></div>
                                        </div>
                    ...
                    <table id="tbllstclass">
                        ...
                        <tr>
                            ...
                            <th style="width:35%">Tiêu đề tin tuyển dụng
                            </th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="actionjob">
                                    <a data-val="<?php echo $n->ID; ?>" class="btnntdedit" id="sualopdaluu">Sửa</a>

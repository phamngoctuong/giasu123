...
<section class="padd-top-0">
    ...
    <div class="col-left col-md-9 hdright">
      <div class="info">        
        <h3 class="title support"><i class="fa fa-info-circle"></i> Hướng dẫn đăng ký tài khoản gia sư</h3>
      </div>
      <div class="content">
        ...
        <div class="step01"><h2><span><span>Bước 2:</span> Chọn <b>"ĐĂNG KÝ LÀM GIA SƯ"</b></span></h2>    
              
        </div>
        <p><img src="images/hd-dang-ky-giasu.jpg" /></p>  
        <div class="step01"><h2><span><span>Bước 3:</span> Các thông tin yêu cầu khi đăng kí bao gồm:</span></h2>    
              <h4><span><span>Bước 3.1:</span> Thông tin đăng nhập:</span></h4>
        </div>
            <ul>
                <li style="line-height: 30px;"><b>Họ tên đầy đủ: </b><span>Nhập họ tên của bạn</span></li>
                <li style="line-height: 30px;"><b>Số điện thoại: </b><span>Nhập số điện thoại của bạn (SĐT sẽ là tài khoản để bạn đăng nhập).</span></li>
                <li style="line-height: 30px;"><b>Mật khẩu: </b><span>Nhập mật khẩu để đăng nhập (mật khẩu phải từ 6 kí tự trở lên).</span></li>
                <li style="line-height: 30px;"><b>Nhập lại mật khẩu: </b><span>Nhập lại đúng mật khẩu đã nhập lần 1để xác nhận.</span></li>
            </ul>
            <p><img src="images/hd-dang-ky-giasu2.jpg" /></p>
        <div class="step01">   
              <h4><span><span>Bước 3.2:</span> Thông tin cá nhân:</span></h4>
        </div>
        <ul>
                <li style="line-height: 30px;"><b>Email: </b><span>Nhập chính xác email của bạn.</span></li>
                <li style="line-height: 30px;"><b>Ảnh đại diện: </b><span>Chọn ảnh đại diện của bạn.</span></li>
                <li style="line-height: 30px;"><b>Ảnh CMND, thẻ sinh viên hoặc bằng cấp chuyên môn cao nhất </b><span>(để tăng sự tin tưởng của phụ huynh, học viên với bạn).</span></li>
                <li style="line-height: 30px;"><b>Ngày/ tháng/ năm sinh. </b><span></span></li>
                <li style="line-height: 30px;"><b>Giới tính: </b><span>Nhập giới tính của bạn</span></li>
                <li style="line-height: 30px;"><b>Nơi ở hiện tại: </b><span>Nhập chi tiết nơi ở hiện tại của bạn.</span></li>
                <li style="line-height: 30px;"><b>Hiện tại bạn đang là: </b><span>Lựa chọn thông tin đúng với bạn.</span></li>
                <li style="line-height: 30px;"><b>Học trường: </b><span>Nhập tên trường học của bạn (đại học, cao đẳng, ...).</span></li>
                <li style="line-height: 30px;"><b>Chuyên ngành: </b><span>Chọn chuyên ngành học của bạn.</span></li>
                <li style="line-height: 30px;"><b>Năm tốt nghiệp: </b><span>Nhập năm bạn tốt nghiệp, ra trường.</span></li>
                <li style="line-height: 30px;"><b>Nơi công tác </b><span>(nếu bạn đã đi làm): Nhập nơi hiện tại bạn đang công tác.</span></li>
                <li style="line-height: 30px;"><b>Kinh nghiệm đi dạy: </b><span>Bạn đã có những kinh nghiệm gì trong công tác giảng dạy.</span></li>
                <li style="line-height: 30px;"><b>Thành tích: </b><span>Nêu những thành tích liên quan nổi bật bạn đã đạt được</span></li>
                <li style="line-height: 30px;"><b>Giới thiệu chung về bản thân.</b><span></span></li>
                
            </ul>
            <div class="step01">   
              <h4><span><span>Bước 3.3:</span> Thông tin hồ sơ:</span></h4>
        </div>
        <ul>
                <li style="line-height: 30px;"><b>Môn đăng ký dạy: </b><span>Chọn môn học bạn muốn nhận dạy.</span></li>
                <li style="line-height: 30px;"><b>Lớp hoặc chủ đề môn học: </b><span>Chọn lớp hoặc chủ đề giúp giáo viên tìm kiếm bạn dễ hơn.</span></li>
                <li style="line-height: 30px;"><b>Khu vực dạy: </b><span>Chọn tỉnh/ thành phố, quận/ huyện bạn muốn đi dạy.</span></li>
                <li style="line-height: 30px;"><b>Số giờ dạy 1 buổi: </b><span>Chọn số giờ dạy 1 buổi</span></li>
                <li style="line-height: 30px;"><b>Hình thức dạy: </b><span>Chọn hình thức dạy</span></li>
                <li style="line-height: 30px;"><b>Học phí dự kiến: </b><span>Nhập mức học phí dự kiến phù hợp.</span></li>
                <li style="line-height: 30px;"><b>Buổi có thể dạy: </b><span>Bấm để chọn những buổi bạn có thể dạy.</span></li>
                <li style="line-height: 30px;"><b>Thông tin khác: </b><span>Nhập thông tin bạn muốn thêm. Ví dụ: Mong muốn nhận được học sinh ngoan, ..</span></li>
            </ul>
            <div class="linkbtn"><a>Bạn có thể thêm công việc, môn học khác mà bạn muốn dạy</a></div>
        <div class="step01">
            <h2><span><span>Bước 4:</span> Chọn "Tôi cam kết các thông tin trên đây là thật. Tôi chấp nhận các quy định của giasu365". Và nhấn
nút Hoàn tất.</span></h2>
        </div>
        <p><img src="images/hd-dang-confirm-dk.jpg" /></p>
        <br />
        <div class="infonews">
            <p>Như vậy, Quý khách đã hoàn thành xong việc đăng ký tài khoản gia sư và có thể sử dụng các tính năng </p>

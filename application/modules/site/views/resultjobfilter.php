...
<section class="brows-job-category">
 ...
 Sinh học</option> 
								...
								<div class="col-md-3 col-sm-3">
									<select id="index_dia_diem" class="city_ab form-control">                        
								...
								<div class="col-md-2 col-sm-2">
									<button type="button" class="timvieclam btn btn-success full-width">Tìm kiếm</button>
								</div>
							</form>
						</div>
					</div>
...
$('#index_nganhnghe').select2({ width: 'calc(100%)' }).select2("val", "<?php echo $params['nganhnghe'] ?>");
$('#index_dia_diem').select2({ width: 'calc(100%)' }).select2("val", "<?php echo $params['diadiem'] ?>");

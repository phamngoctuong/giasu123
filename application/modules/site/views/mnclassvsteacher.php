                        ...
                        <?php if(!empty($uservsclass)){
                            foreach($uservsclass as $n){ ?>
                             <tr>
                                ...
                                <td><?php if($n->daday == 1){echo "Đã đồng ý dạy";}else if($n->daday == 0){echo "Chưa cập nhật";}else if($n->daday == 2){echo "Không đồng ý";}else{echo "Tạm nghỉ";} ?></td>
                                <td class="actionjob">
            ...
            <div class="col-md-12">
                <div class="row padd-top-15 padd-bot-5" style="">
                    <div class="col-md-5 padd-r-0">
                        ...
                        <label for="radio-1" class="radio-custom-label">Đồng ý</label>
                        </div>
                        <div class="group-radio">
                            <input id="radio-2" value="2" class="radio-custom"name="radio-group" type="radio">
                            <label for="radio-2" class="radio-custom-label">Hủy dạy</label>
                        </div>
                        <!--<div class="group-radio">
                    ...
                    <div class="col-md-7">
                        <div class="form-group" style="margin:5px auto;">
                            <textarea rows="4" cols="5" id="txtghichu" name="txtghichu" placeholder="Ghi chú" style="width:100%;padding:7px;height:76px;"></textarea>
                        </div>
                    </div>
                </div>
                ...
                $.ajax(
                      {
                          ...
                          url: configulr+"site/ajaxupdatestatusclassvsusers",
                          type: "POST",
                          data: { 

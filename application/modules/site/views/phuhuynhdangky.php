    ...
    <div class="container">
        ...
        <div class="row padd-bot-40">
            <div class="col-md-10 col-md-offset-1">
                ...
                <form action="<?php echo site_url('site/postformuserregistersuccess') ?>" method="POST" id="my_form">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-control"><input type="password" id="txtpass" name="txtpass" /></div>
                    </div>
                    <div class="col-md-6">
           ...
           /* if ($.trim($('#txtclassname').val()) == '') {
                ...
                if ($.trim($('#txtemail').val()) != '') {
                    if (!Common.IsValidEmail($('#txtemail').val())) {
                        $($('#txtemail')).tooltip('hide').attr('data-original-title', 'Email không h?p l?').tooltip('show').addClass('errorClass');
                        flag = false;
                    } else {

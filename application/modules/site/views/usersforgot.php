        ...
        <div class="formlogin frmfogotpass">
            ...
            <div class="fogotmypassword">
                ...
                <div class="group-control">
                        ...
                        <div class="form-control"><input type="text" id="emailuser" name="emailuser" placeholder="Điền tài khoản đăng nhập"/></div>
            ...
            <!--<a class="btnuserforgotpassword" id="btntestsendsms">Lấy lại mật khẩu</a>-->
            </div>
...
$(document).ready(function() {
    ...
    $('#btntestsendsms').on('click',function(){
        $.ajax(
              {
                  
                  url: configulr+"/site/ajaxtestsendpass",
                  type: "POST",
                  data: {  },
                  dataType: 'json',
                  beforeSend: function () {

       ...
       <div class="row">
           <div class="col-md-12">
               <div class="tit_hd resultfindteacher">
                <div class="ir_h3"><h1><span> <?php if(strtolower($keywork)=='all'){echo "Tất cả gia sư";}else{
                  if(empty($class)){
                    if(!empty($subjectname) && !empty($cityname)){
                      echo 'Hồ sơ gia sư dạy kèm '.$subjectname.' tại '.$cityname.' mới nhất';
                    }elseif(!empty($subjectname)){
                      echo 'Hồ sơ gia sư dạy kèm '.$subjectname.' mới nhất';
                    }elseif (!empty($cityname)) {
                      echo 'Hồ sơ gia sư dạy kèm tại '.$cityname.' mới nhất';
                    }
                  }else{
                    if(!empty($subjectname) && !empty($cityname)){
                      echo 'Hồ sơ gia sư dạy kèm '.$subjectname.' '.$class.' tại '.$cityname.' mới nhất';
                    }elseif(!empty($subjectname)){
                      echo 'Hồ sơ gia sư dạy kèm '.$subjectname.' '.$class.' mới nhất';
                    }elseif (!empty($cityname)) {
                      echo 'Hồ sơ gia sư dạy kèm '.$class.' tại '.$cityname.' mới nhất';
                    }else{
                      echo 'Hồ sơ gia sư dạy kèm '.$class.' mới nhất';
                    }
                  }
               } ?></span></h1>
                </div>
                       ...
                       <div class="item_lc">
                           ...
                           <div class="col-md-9 col-sm-12">
                               <div class="giasu_info">
                                   <a rel="nofollow" href="<?php echo base_url().vn_str_filter($n->Name).'-gv'.$n->UserID ?>" title="<?php echo $n->Name ?>" class="giasu_name"><i class="fa fa-online"></i><?php echo $n->Name ?> <i class="fa fa-chat"></i></a>
                                   ...
                                   <span class="giasu_luong">Từ: <span><?php if(intval($n->Free)>0){echo number_format($n->Free)." vnđ/buổi";}else{echo "Thỏa thuận";}  ?></span></span>
                                   <p><?php
                       ...
                       <?php if(!empty($chude)){
                           ...
                           <div class="itemfeature">
                               ...
                               <div class="feature-caption">
                                   <a rel="nofollow" href="<?php echo base_url().vn_str_filter($n->Name).'-gv'.$n->UserID ?>" title="<?php echo $n->Name; ?>" class="feature_name"><i class="fa fa-online"></i><?php echo $n->Name ?> <i class="fa fa-chat"></i></a>

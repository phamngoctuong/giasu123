...
<form name="frmsearch" method="post" action="<?php echo site_url('admin/ungvien'); ?>">
...
<select id="category" name="category" class="city_ab" style="width:150px;">
                        <option data-tokens="" value="">Loại TK</option>
                                    <option data-tokens="1" value="1">Phụ Huynh, Học viên</option>
                                                                        <option data-tokens="3" value="3">Ứng viên</option>
                                                                        <option data-tokens="4" value="4">Nhà tuyển dụng</option>

                     </select>
<select id="city" name="city" class="city_ab" style="width:150px;" value="Tỉnh thành">
...
<form name="frmxoaall" id="frmxoaall" method="post" action="<?php echo site_url('admin/del_ungvien'); ?>">
<p class="sidebar"><a href="<?php echo site_url('admin/frmungvien'); ?>">Thêm mới</a> <input type="submit" name="submit" value="Xóa" /></p>
<table width="100%" style="display:block;">
    <tr class="title">
        ...
        <td width="10%">Khoá/Mở tài khoản</td>
    ...
    ?>
		<tr class="<?php echo $stt%2 ? 'odd' : 'even'; ?>">
			...
			<td><a href="<?php echo site_url('admin/edit_ungvien/'.$item->UserID); ?>"><?php echo $item->Name; ?></a></td>
            ...
            <td align="center">
			  ...
			  ?>
			  <a class="status" onclick="check_statusck('users','Active',0,'UserID',<?php echo $item->UserID; ?>);check_statusck('user_company','usc_active',1,'UserID',<?=$item->UserID;?>)"><img src="images/toolbar/tick.png"></a>
			  ...
			  ?>
			  <a class="status" onclick="check_statusck('users','Active',1,'UserID',<?php echo $item->UserID; ?>);check_statusck('user_company','usc_active',0,'UserID',<?php echo $item->UserID; ?>)"><img src="images/toolbar/publish_x.png"></a>
			  <?php
			...
			<td><?php
				echo Getcitybyindex($item->CityID);
			?></td>

			<td align="center"><?php echo $item->UserID; ?></td>
            <td>
            <?php if($item->UserType ==0){echo "Phụ Huynh/HV";}else if($item->UserType ==1){echo "Gia Sư";}else if($item->UserType ==3){echo "Ứng viên";}else if($item->UserType ==4){echo "Nhà tuyển dụng";} ?>
            </td>
		</tr>
    <?php
    }

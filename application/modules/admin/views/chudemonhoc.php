...
<form name="frmsearch" method="post" action="<?php echo site_url('admin/chudemonhoc'); ?>">
...
<form name="frmxoaall" id="frmxoaall" method="post" action="<?php echo site_url('admin/del_chudemonhoc'); ?>">
<p class="sidebar"><a href="<?php echo site_url('admin/frmchudemonhoc'); ?>">Thêm mới</a> <input type="submit" name="submit" value="Xóa" /></p>
<table width="100%" style="display:block;">
    ...
    ?>
		<tr class="<?php echo $stt%2 ? 'odd' : 'even'; ?>">
			...
			<td><a href="<?php echo site_url('admin/edit_chudemonhoc/'.$item->ID); ?>"><?php echo $item->NameTopic; ?></a></td>
            <td><a href="<?php echo site_url('admin/edit_monhoc/'.$item->SubjectID) ?>"><?php echo $item->SubjectName ?></a> </td>

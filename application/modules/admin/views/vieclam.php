...
<form name="frmxoaall" id="frmxoaall" method="post" action="<?php echo site_url('admin/del_vieclam'); ?>">
...
<table width="100%" style="display:block;">
    ...
    ?>
		<tr class="<?php echo $stt%2 ? 'odd' : 'even'; ?>">
			...
			echo date('d/m/Y',strtotime($item->UpdateDate)); ?></td>
			<td align="center">
			  <?php
			  if($item->IsSearch=='1')
			  {
			  ...
			  //}else{
			  ?>
			  <a class="status" onclick="check_statusck('users','IsSearch',0,'UserID',<?php echo $item->UserID; ?>)"><img src="images/toolbar/tick.png"></a>
			  <?php
			  }
			  else
			  {
			  ?>
			  <a class="status" onclick="check_statusck('users','IsSearch',1,'UserID',<?php echo $item->UserID; ?>)"><img src="images/toolbar/publish_x.png"></a>
			  <?php
			  }
			  ?>
			</td>
            ...
            <td align="center">
			  ...
			  {
			  ?>
			  <a class="status" onclick="check_statusck('userteacher','Vip',0,'UserID',<?php echo $item->UserID; ?>)"><img src="images/toolbar/tick.png"></a>
			  <?php
			  }
			  else
			  {
			  ?>
			  <a class="status" onclick="check_statusck('userteacher','Vip',1,'UserID',<?php echo $item->UserID; ?>)"><img src="images/toolbar/publish_x.png"></a>
			  <?php
			  }
			  ?>
			</td>

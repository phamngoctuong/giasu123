<?xml version="1.0" encoding="UTF-8"?>
	...
	<xsl:template match="/">
		...
		<div id="content">
			<h1>XML Sitemap</h1>
			<p class="expl">
				Generated by NBD, this is an XML Sitemap, meant for consumption by search engines.<br/>
			...
			<xsl:if test="count(sitemap:sitemapindex/sitemap:sitemap) &lt; 1">
				...
				<p class="expl">
					This XML Sitemap images <xsl:value-of select="count(sitemap:urlset/sitemap:url/image:image)"/> pics.
				</p>

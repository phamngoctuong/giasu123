...
Class Asido {
	...
	* @static
	*/
	static function driver($driver_name) {
	...
	* @static
	*/
	static function __driver_classname($driver_name) {
	...
	* @static
	*/
	static function get_supported_types($mode=ASIDO_SUPPORT_READ_WRITE) {
	...
	* @static
	*/
	static function is_format_supported($mime_type, $mode=ASIDO_SUPPORT_READ_WRITE) {
	...
	* @static
	*/
	static function &_driver($driver=null) {
...
//			if (!is_a($driver, 'Asido_Driver')) {
	...
	* @static
	*/
	static function resize(&$image, $width, $height, $mode=ASIDO_RESIZE_PROPORTIONAL) {
	...
	* @static
	*/
	static function width(&$image, $width) {
		return asido::_operation(
				$image, 'resize',
				array(
					'width' => $width,
	...
	* @static
	*/
	static function height(&$image, $height) {
		return asido::_operation(
				$image, 'resize',
				array(
					'width' => 0,
	...
	* @static
	*/
	static function stretch(&$image, $width, $height) {
		return asido::_operation(
				$image, 'resize',
				array(
					'width' => $width,
	...
	* @static
	*/
	static function frame(&$image, $width, $height, $color=null) {
		return asido::_operation(
				$image, __FUNCTION__,
				array(
					'width' => $width,
	...
	* @static
	*/
	static function convert(&$image, $mime_type) {
		return asido::_operation(
				$image, __FUNCTION__,
				array(
					'mime' => $mime_type
	...
	* @static
	*/
	static function watermark(&$image, $watermark_image,
	...
	* @static
	*/
	static function copy(&$image, $applied_image, $x, $y) {
		return asido::_operation(
				$image, __FUNCTION__,
				array(
					'image' => $applied_image,
	...
	* @static
	*/
	static function _operation(&$image, $operation, $params) {
...
//		if (!is_a($image, 'Asido_Image')) {
	...
	* @static
	*/
	static function trigger_abstract_error($class, $function) {
		trigger_error(
			sprintf(
